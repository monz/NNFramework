function [ outData ] = simSISO_Time( net, data, useToolbox )
%SIMSISO Simulates the data prepared for SISO_Time training method
...
%                   otherwise it uses the NN-Framework
    ...
    yTest = zeros(2, numTests*dataSize);
    fitTest = zeros(2, numTests);
